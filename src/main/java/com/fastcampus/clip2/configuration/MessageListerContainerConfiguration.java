package com.fastcampus.clip2.configuration;

import com.fastcampus.clip2.consumer.listener.DefaultMessageListener;
...
@Configuration
public class MessageListerContainerConfiguration {
